...
from benchmarks.text_mp.substrates.clean_up.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.clean_up.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Clean Up Text Melting Pot benchmark.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: clean_up:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("clean_up_events",),
