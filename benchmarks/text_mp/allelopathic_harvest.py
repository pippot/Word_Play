...
from benchmarks.text_mp.substrates.allelopathic_harvest.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.allelopathic_harvest.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run an Allelopathic Harvest Text Melting Pot benchmark.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: allelopathic_harvest:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("allelopathic_events",),
