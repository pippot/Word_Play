...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Commons Harvest Text Melting Pot example.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: commons_harvest:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("commons_events",),
