...
MODEL_KEY = "chemistry__two_metabolic_cycles"
...
def run_exp(agent_count: int, policy: str, model_name: str):
    ...
    for agent_id, (x, y) in enumerate(spawn_positions[:agent_count], start=1):
        ...
        agent_policy = (
            LLM_Action_And_Communication_Policy(
                model_key=MODEL_KEY,
                system_prompt=(
                    "You are playing Chemistry: Two Metabolic Cycles. "
                    ...
                    "Food1 and food2 pay +1 automatically while held. "
    ...
    env = Simple_2D_Grid_World(
        description="Chemistry: Two Metabolic Cycles, adapted from MeltingPot.",
        entities=entities,
