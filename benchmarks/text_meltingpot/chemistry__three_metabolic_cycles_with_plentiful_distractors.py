...
MODEL_KEY = "chemistry__three_metabolic_cycles_with_plentiful_distractors"
...
def run_exp(agent_count: int, policy: str, model_name: str):
    ...
    for agent_id, (x, y) in enumerate(spawn_positions[:agent_count], start=1):
        ...
        agent_policy = (
            LLM_Action_And_Communication_Policy(
                model_key=MODEL_KEY,
                system_prompt=(
                    "You are playing Chemistry: Three Metabolic Cycles With Plentiful Distractors. "
                    ...
                    "Distractors pay only +0.1 while held; x+y and food3 pay +10. "
    ...
    env = Simple_2D_Grid_World(
        description="Chemistry: Three Metabolic Cycles With Plentiful Distractors, adapted from MeltingPot.",
        entities=entities,
